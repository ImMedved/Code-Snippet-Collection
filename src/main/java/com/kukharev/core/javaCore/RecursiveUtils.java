...
public class RecursiveUtils {
    ...
    public static String genPalindr(String str, boolean even) {
        ...
        return even ? sb + sb.reverse().toString() : sb + sb.reverse().deleteCharAt(0).toString();
    }
    ...
    public static int genPalindr(int number, boolean even) {
        ...
        if (even) return Integer.parseInt(sb + sb.reverse().toString());
        else return Integer.parseInt(sb + sb.reverse().deleteCharAt(0).toString());
    }
    ...
    public static int countSubstringOccurrences(String str, String sub) {
        ...
        if (str.startsWith(sub)) return 1 + countSubstringOccurrences(str.substring(1), sub);
