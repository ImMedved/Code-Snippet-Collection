...
package com.kukharev.core.javaFX.knightTour;
...
public class KnightTour extends Application {
    ...
    private final int[][] board = new int[SIZE][SIZE]; // Chessboard
    private final List<int[]> path = new ArrayList<>(); // The way of the knight
